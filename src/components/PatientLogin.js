      ...
      <div className="bg-gradient-to-b from-sky-800 to-pink-200 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-white">
        <div className="w-full max-w-4xl bg-gray-900 p-20 rounded-lg shadow-lg">
          ...
          <button
            ...
            className="px-6 py-3 bg-rose-500 text-white font-bold text-lg rounded-lg cursor-pointer transition-transform transition-colors duration-300 ease-in hover:bg-rose-600 active:bg-rose-700"
          >
            Login
            </button>
            <button
