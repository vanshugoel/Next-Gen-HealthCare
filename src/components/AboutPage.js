...
const AboutUs = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-sky-800 to-pink-200">
      <NavBar />
      <div className="hospital-image-container py-20 mb-0">
        <img
      ...
      <div className="flex justify-center items-center  mt-0 ">
        <div className="flex flex-col text-custom-blue space-y-8 w-3/5 p-10 bg-gray-800 shadow-lg rounded-3xl transition-transform duration-10000 ease-in-out transform hover:scale-105">
          <div className="space-y-4">
            ...
            <div className="about-content text-left"> {/* Left align the content */}
              ...
              <p>
                ...
                Health Records (EHR) are managed by our software "Next-Gen-Healthcare".
                Our mission is to provide a secure, efficient, and user-friendly platform for managing EHR.
              </p>
      ...
      <div className="flex justify-center">
        <button
          className="bg-gray-800 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-110 hover:bg-rose-600 py-2 m-5"
          onClick={() => {
            navigate("/");
          }}
        >
