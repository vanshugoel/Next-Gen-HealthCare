...
const PatientRegistry = () => {
  ...
  return (
    <div>
    <NavBar></NavBar>
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-sky-800 to-pink-200 font-mono">
        ...
        <div className="mb-4">
          ...
          <div className="space-x-4 md:col-span-2 flex justify-center mt-6">
            <button
              ...
              className="px-5 py-2.5 bg-green-600 text-white font-bold text-lg rounded-lg cursor-pointer transition-colors duration-300 ease-in-out hover:bg-rose-700 disabled:bg-gray-600 disabled:cursor-not-allowed w-full md:w-auto"
            >
              Register
            </button>
            <button
