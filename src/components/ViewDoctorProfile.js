...
const ViewDoctorProfile = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-b from-sky-800 to-pink-200 p-4 sm:p-10 font-mono text-white flex flex-col justify-center items-center">
        <div className="h-full max-w-8xl bg-gray-800 p-24 rounded-lg shadow-lg flex flex-col justify-center items-center">
