      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="space-x-4 text-center mt-6">
          <button
            ...
            className="py-3 px-4 bg-green-600 text-white rounded-md font-medium hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-700"
          >
            Register 
            </button>
            <button
