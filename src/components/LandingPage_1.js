...
import lp_11 from "./lp_11.webp";
import lp_10 from "./lp_10.webp";
import lp_12 from "./lp_12.webp";
...
function LandingPage() {
  ...
  return (
    <div>
        <NavBar></NavBar>
      <div className="bg-gradient-to-b from-sky-800 to-pink-200 text-white font-sans min-h-screen flex items-center justify-center">
        <div
        ...
        >
          ...
          <div className="flex flex-col text-custom-blue space-y-8 w-2/5 p-8 bg-gray-800 shadow-lg ml-4 rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
            <div className="space-y-4">
              ...
              The Next-Gen-Healthcare App is revolutionizing EHR management by leveraging blockchain technology. 
              Utilizing key components such as blockchain for secure and transparent data storage, Ganache for rapid development,
              Metamask for seamless blockchain interaction, and IPFS desktop for decentralized file storage, 
              It ensures enhanced security, improved accessibility, data interoperability, and trust. By adopting this innovative approach,
